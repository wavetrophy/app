...
NAME=WAVETROPHY
KEYSTORE=/Users/bjorn/GDrive/Business/WAVETROPHY/App/Android/Keys/wavetrophy-release-key-android.keystore
...
${APKSIGNER} sign --ks ${KEYSTORE} --ks-pass ${KEYSTORE_PASSWORD} --v2-signing-enabled=true --out ${RELEASE_APK} ${BUILD_APK}.tmp | tee ${PWD}/build.log
#rm -f $TMP
echo "Signed"
echo "Zipping ..."
echo "Zipped"
